<template>
  <div>
    <div class="landingpage_banner w-full">
      <div class="landingpage_banner_inside w-3/4">
        <h1 class="leading-none">Help Return Someone's Bestfriend Home</h1>
        <p class="text-yellow-300">Reuniting Lost Pets who were in Auto Accidents</p>
      </div>
      <svg
